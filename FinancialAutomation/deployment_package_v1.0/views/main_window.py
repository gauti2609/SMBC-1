...
class MainWindow(QMainWindow):
    ...
    def on_company_saved(self, company_id, entity_name):
        ...
        if company:
            ...
            # Update window title
            self.setWindowTitle(f"Financial Automation - {entity_name}")
            
            # Update company status label if it exists
            if hasattr(self, 'company_status_label'):
    ...
    def load_company(self, company_id):
        ...
        try:
            ...
            if company:
                ...
                # Update window title
                self.setWindowTitle(f"Financial Automation - {company.entity_name}")
    ...
    def load_last_session(self):
        ...
        try:
            ...
            companies = CompanyInfo.get_all_by_user(self.user.user_id)
            if not companies:
                # No companies, show helpful message
                QMessageBox.information(
                    self,
                    "Welcome!",
                    "No company information found.\n\n"
                    "Please go to the 'Company Info' tab to create your first company profile."
                )
