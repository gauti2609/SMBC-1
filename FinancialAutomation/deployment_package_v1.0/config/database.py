...
from .db_connection import get_connection, execute_query, adapt_sql, close_pool
...
def initialize_database():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS minor_heads (
            ...
            company_id INTEGER NOT NULL,
            minor_head_name VARCHAR(255) NOT NULL,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS trial_balance (
            ...
            opening_balance_cy NUMERIC(15,2) DEFAULT 0,
            debit_cy NUMERIC(15,2) DEFAULT 0,
            credit_cy NUMERIC(15,2) DEFAULT 0,
            closing_balance_cy NUMERIC(15,2) DEFAULT 0,
            -- Previous Year (PY) figures for comparatives
            opening_balance_py NUMERIC(15,2) DEFAULT 0,
            debit_py NUMERIC(15,2) DEFAULT 0,
            credit_py NUMERIC(15,2) DEFAULT 0,
            closing_balance_py NUMERIC(15,2) DEFAULT 0,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS share_capital (
            ...
            authorized_shares NUMERIC(15,2) DEFAULT 0,
            face_value NUMERIC(15,2) DEFAULT 0,
            opening_shares_cy NUMERIC(15,2) DEFAULT 0,
            shares_issued_cy NUMERIC(15,2) DEFAULT 0,
            closing_shares_cy NUMERIC(15,2) DEFAULT 0,
            opening_shares_py NUMERIC(15,2) DEFAULT 0,
            shares_issued_py NUMERIC(15,2) DEFAULT 0,
            closing_shares_py NUMERIC(15,2) DEFAULT 0,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id)
        )
    ''')
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS shareholders (
            ...
            shares_cy NUMERIC(15,2) DEFAULT 0,
            shares_py NUMERIC(15,2) DEFAULT 0,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS ppe_schedule (
            ...
            opening_gross_block_cy NUMERIC(15,2) DEFAULT 0,
            additions_cy NUMERIC(15,2) DEFAULT 0,
            disposals_gross_cy NUMERIC(15,2) DEFAULT 0,
            closing_gross_block_cy NUMERIC(15,2) DEFAULT 0,
            -- Current Year (CY) - Accumulated Depreciation
            opening_acc_depreciation_cy NUMERIC(15,2) DEFAULT 0,
            depreciation_for_year_cy NUMERIC(15,2) DEFAULT 0,
            acc_depr_on_disposals_cy NUMERIC(15,2) DEFAULT 0,
            closing_acc_depreciation_cy NUMERIC(15,2) DEFAULT 0,
            -- Previous Year (PY) - Gross Block
            opening_gross_block_py NUMERIC(15,2) DEFAULT 0,
            additions_py NUMERIC(15,2) DEFAULT 0,
            disposals_gross_py NUMERIC(15,2) DEFAULT 0,
            closing_gross_block_py NUMERIC(15,2) DEFAULT 0,
            -- Previous Year (PY) - Accumulated Depreciation
            opening_acc_depreciation_py NUMERIC(15,2) DEFAULT 0,
            depreciation_for_year_py NUMERIC(15,2) DEFAULT 0,
            acc_depr_on_disposals_py NUMERIC(15,2) DEFAULT 0,
            closing_acc_depreciation_py NUMERIC(15,2) DEFAULT 0,
            -- Metadata
            depreciation_rate NUMERIC(15,2) DEFAULT 0,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS cwip_schedule (
            ...
            opening_balance_cy NUMERIC(15,2) DEFAULT 0,
            additions_cy NUMERIC(15,2) DEFAULT 0,
            capitalized_cy NUMERIC(15,2) DEFAULT 0,
            closing_balance_cy NUMERIC(15,2) DEFAULT 0,
            opening_balance_py NUMERIC(15,2) DEFAULT 0,
            additions_py NUMERIC(15,2) DEFAULT 0,
            capitalized_py NUMERIC(15,2) DEFAULT 0,
            closing_balance_py NUMERIC(15,2) DEFAULT 0,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS intangible_assets (
            ...
            opening_gross_block NUMERIC(15,2) DEFAULT 0,
            additions NUMERIC(15,2) DEFAULT 0,
            disposals_gross NUMERIC(15,2) DEFAULT 0,
            opening_acc_amortization NUMERIC(15,2) DEFAULT 0,
            amortization_for_year NUMERIC(15,2) DEFAULT 0,
            acc_amort_on_disposals NUMERIC(15,2) DEFAULT 0,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id)
        )
    ''')
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS investments (
            ...
            cost_cy NUMERIC(15,2) DEFAULT 0,
            cost_py NUMERIC(15,2) DEFAULT 0,
            fair_value_cy NUMERIC(15,2) DEFAULT 0,
            fair_value_py NUMERIC(15,2) DEFAULT 0,
            carrying_amount_cy NUMERIC(15,2) DEFAULT 0,
            carrying_amount_py NUMERIC(15,2) DEFAULT 0,
            market_value_cy NUMERIC(15,2) DEFAULT 0,
            market_value_py NUMERIC(15,2) DEFAULT 0,
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id)
        )
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS inventories (
            ...
            company_id INTEGER NOT NULL,
            category VARCHAR(100) NOT NULL,  -- Raw Materials / WIP / Finished Goods / Stock-in-Trade / Stores & Spares
            particulars TEXT NOT NULL,
            quantity_cy NUMERIC(15,2) DEFAULT 0,
            quantity_py NUMERIC(15,2) DEFAULT 0,
            unit TEXT,
            value_cy NUMERIC(15,2) DEFAULT 0,
            value_py NUMERIC(15,2) DEFAULT 0,
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id)
        )
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS employee_benefits (
            ...
            company_id INTEGER NOT NULL,
            pf_contribution_cy NUMERIC(15,2) DEFAULT 0,
            pf_contribution_py NUMERIC(15,2) DEFAULT 0,
            gratuity_current_service_cost_cy NUMERIC(15,2) DEFAULT 0,
            gratuity_current_service_cost_py NUMERIC(15,2) DEFAULT 0,
            gratuity_interest_cost_cy NUMERIC(15,2) DEFAULT 0,
            gratuity_interest_cost_py NUMERIC(15,2) DEFAULT 0,
            gratuity_actuarial_gain_loss_cy NUMERIC(15,2) DEFAULT 0,
            gratuity_actuarial_gain_loss_py NUMERIC(15,2) DEFAULT 0,
            gratuity_obligation_cy NUMERIC(15,2) DEFAULT 0,
            gratuity_obligation_py NUMERIC(15,2) DEFAULT 0,
            gratuity_plan_assets_cy NUMERIC(15,2) DEFAULT 0,
            gratuity_plan_assets_py NUMERIC(15,2) DEFAULT 0,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id)
        )
    ''')
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS tax_information (
            ...
            company_id INTEGER NOT NULL,
            current_tax_cy NUMERIC(15,2) DEFAULT 0,
            current_tax_py NUMERIC(15,2) DEFAULT 0,
            deferred_tax_cy NUMERIC(15,2) DEFAULT 0,
            deferred_tax_py NUMERIC(15,2) DEFAULT 0,
            applicable_tax_rate NUMERIC(15,2) DEFAULT 0,
            non_deductible_expenses NUMERIC(15,2) DEFAULT 0,
            other_differences NUMERIC(15,2) DEFAULT 0,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id)
        )
    ''')
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS related_party_transactions (
            ...
            amount_cy NUMERIC(15,2) DEFAULT 0,
            amount_py NUMERIC(15,2) DEFAULT 0,
            balance_outstanding_cy NUMERIC(15,2) DEFAULT 0,
            balance_outstanding_py NUMERIC(15,2) DEFAULT 0,
            FOREIGN KEY (company_id) REFERENCES company_info(company_id),
